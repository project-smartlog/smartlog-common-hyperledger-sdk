...
public class TestConfig {
    ...
    //Configure this for local environment
    private static String environmentPath;

    private TestConfig(OrganisationConfiguration conf) {
        environmentPath = conf.fabricEnvPath;
        File loadFile;
...
//                    DEFAULT_CONFIG));
            ...
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.peer_locations", "peer0.org1.example.com@grpc://localhost:7051");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.orderer_locations", "orderer.example.com@grpc://localhost:7050");
            defaultProperty(INTEGRATIONTESTS_ORG + "peerOrg1.eventhub_locations", "peer0.org1.example.com@grpc://localhost:7053");
     ...
     */
    public static TestConfig getConfig(OrganisationConfiguration configuration) {
        if (null == config) {
    ...
    private Properties getEndPointProperties(final String type, final String name) {
        ...
        File cert = Paths.get(environmentPath, "crypto-config/ordererOrganizations".replace("orderer", type), domainName, type + "s",
